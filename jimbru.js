...
//[target]\\
	const reply = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Join Bot's Official Group`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./Media/Jimbru.jpg`),"sourceUrl": "https://chat.whatsapp.com/HiWMAqrg8YN6B7naCA2q9o"}}}, { quoted: m})
        }
...
case 'antilink':
 ...
 reply(`Pilih Antilink On / Off `)
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                      ...
                      fatihgans = fs.readFileSync('./Media/Jimbru.jpg')
                      let txt = `「 ✫ 𝑱𝑰𝑴𝑩𝑹𝑼 𝑩𝑹𝑶𝑨𝑫𝑪𝑨𝑺𝑻 ✫ 」\n\n${text}`
	    ...
	    break
            ...
            break
	        case 'tomp4': case 'tovideo': case 'video': {
                if (!quoted) throw 'Reply Image'
                if (!/webp/.test(mime)) throw `balas stiker dengan caption *${prefix + command}*`
                replay(mess.wait)
	    ...
	    let apirnobg = ['q61faXzzR5zNU6cvcrwtUkRU','ZCQNqqcfvioAC6vGvDxWYSHB']
	    ...
	    case 'anonymous': {
				...
				let buttons = [{
                                urlButton: {
                                    ...
                                    url: 'https://wa.me/919544846609?text=hey+ Mikhaiel bro+i+found+a+bug+in+your+bot'
                                }
                            }, {
                                quickReplyButton: {
           ...
           XeonBotInc.sendMessage(m.chat, { audio: devsound, mimetype: 'audio/mp4', ptt: true, quoted: m })
            ...
            break
                    case 'bug': case 'report': {
                    	...
                    	XeonBotInc.sendMessage(`919544846609@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
